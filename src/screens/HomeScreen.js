    ...
    <View style={styles.container}>
      ...
      <ScrollView bounces={false}>
        <View style={styles.home}>
          <Text style={styles.text1}> Get Comfortable</Text>
        ...
        <View style={styles.view5}>
          <View style={styles.view6}>
            ...
            <View>
              ...
              <Text style={{ color: colors.grey3 }}>Kigali, Kacyiru</Text>
            </View>
          </View>
          <View>
            <Icon
        ...
        <View style={{ ...styles.view5, borderBottomWidth: 0 }}>
          <View style={styles.view6}>
            ...
            <View>
              ...
              <Text style={{ color: colors.grey3 }}>Kigali, Kimironko</Text>
            </View>
          </View>
          <View>
            <Icon
        ...
        <Text style={styles.text4}>My Location</Text>
